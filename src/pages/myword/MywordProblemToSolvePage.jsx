...
import MywordProblemToSolveMain from "../../components/myword/problemtosolve/MywordProblemToSolveMain.jsx";
...
export default function MywordProblemToSolvePage() {
        ...
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{display: 'flex'}}>
                ...
                <UpperAppBar
                    ...
                    mainTitle={`${mywordNameParam} 단어장 문제풀기`}
                />
                ...
                {/*애만 가져와서 신경쓰면 됨..*/}
                <MywordProblemToSolveMain loginSessionInfo={loginSessionInfo}/>
