...
import MywordDetailMain from "/src/components/myword/detail/MywordDetailMain.jsx";
...
export default function MywordDetailPage() {
        ...
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{display: 'flex'}}>
                ...
                <UpperAppBar
                    ...
                    mainTitle={`${mywordNameParam} 단어장 상세보기`}
                />
                ...
                {/*애만 가져와서 신경쓰면 됨..*/}
                <MywordDetailMain loginSessionInfo={loginSessionInfo}/>
