...
import MyPageDeleteAccountMain from "../../components/mypage/deleteaccount/MyPageDeleteAccountMain.jsx";
...
export default function MyPageDeleteAccountPage() {
    ...
    return (
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{display: 'flex'}}>
                ...
                {/*애만 가져와서 신경쓰면 됨..*/}
                <MyPageDeleteAccountMain loginSessionInfo={loginSessionInfo}/>
