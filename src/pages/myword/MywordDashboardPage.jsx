...
import MywordDashboardMain from "../../components/myword/dashboard/MywordDashboardMain.jsx";
...
export default function MywordDashboardPage() {
    ...
    return (
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{display: 'flex'}}>
                ...
                {/*애만 가져와서 신경쓰면 됨..*/}
                <MywordDashboardMain loginSessionInfo={loginSessionInfo}/>
